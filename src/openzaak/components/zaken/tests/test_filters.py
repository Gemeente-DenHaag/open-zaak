...
class ZaakFilterTests(JWTAuthMixin, APITestCase):
    ...
    def test_filter_by_external_and_local_zaaktype(self):
        # External
        ZaakFactory.create(zaaktype="https://openzaak.nl/zaaktypen/123")
        ZaakFactory.create(zaaktype="https://openzaak.nl/zaaktypen/456")
        # Internal
        ...
        response = self.client.get(
            reverse(Zaak),
            {"zaaktype__in": f"https://openzaak.nl/zaaktypen/123,{local_zaaktype_url}"},
